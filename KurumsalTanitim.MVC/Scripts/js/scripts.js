...
$(document).ready(function(e) {
  ...
  var $searchBtn = $('.search-btn');
	...
	//var $iletisimLink = $('#iletisimLink');
	//var $markalarimizFooter = $('#markalarimizFooter');
	...
	*******************************************/
	...
	//$anasayfaLink.click(function () {
	//	$('html, body').animate({ scrollTop: 0 }, { duration: 700, easing: "easeOutExpo" });
	//});


 //   $markalarimizLink.click(function () {
 //       console.log($markalarimizFooter);
	//	$('html, body').animate({ scrollTop: $markalarimizFooter.offset().top }, { duration: 700, easing: "easeOutExpo" });
	//});


	//$hakkimizdaLink.click(function () {
	//	$('html, body').animate({ scrollTop: $markalarimizFooter.offset().top }, { duration: 700, easing: "easeOutExpo" });
	//});


	//$iletisimLink.click(function () {
	//	$('html, body').animate({ scrollTop: $markalarimizFooter.offset().top }, { duration: 700, easing: "easeOutExpo" });
	//});

 //   $(document).on('click', 'a[href^="#"]', function (event) {
 //       event.preventDefault();
 //       $('html, body').animate({ scrollTop: $($.attr(this, 'href')).offset().top }, { duration: 700, easing: "easeOutExpo" });
 //   });
